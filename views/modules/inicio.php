<section>
      <div id="carouselExampleIndicators" class="carousel zoom landscape slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <a href="detail" class="carousel-item active" style="background-image: url('http://www.arturocogollo.com/images/<?php echo '1.jpg'; ?>')">
          </a>
          <!-- Slide Two - Set the background image for this slide in the line below -->
          <a href="detail" class="carousel-item" style="background-image: url('http://www.arturocogollo.com/images/<?php echo '2.jpg'; ?>')">
          </a>
